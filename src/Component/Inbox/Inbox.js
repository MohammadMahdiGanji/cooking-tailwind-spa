...
export default function Inbox() {
  const inbox = CreateElement({ name: "section", style: "mt-28 text-center" });
  ...
  const btn = Button({ title: "Subscribe" });
  const imgSalad = CreateElement({
    name: "img",
    src: saladSrc,
    style: "absolute -top-10 -left-10 z-10 sm:top-auto w-[250px] sm:-bottom-40 sm:-left-40 sm:w-[400px] lg:w-[500px]",
  });
  const imgPlate = CreateElement({
    name: "img",
    src: plateSrc,
    style: "absolute -bottom-20 -right-20 z-10  w-[250px] sm:-bottom-40 sm:-right-40 sm:w-[400px] lg:w-[500px]",
  });
